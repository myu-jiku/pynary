...
from pynary import PYNDecoder, PYNEncoder, pynfunc
...
class PYNBlank:
    ...
    def add_none(self) -> None:
        encode, decode = pynfunc.build_none()

        self.encoder.add_type(type(None), encode)
        self.decoder.add_type(decode)

    def add_bool(self) -> None:
        encode, decode = pynfunc.build_bool()
    ...
    def add_int(self, size: int = None, signed: bool = None) -> None:
        ...
        encode, decode = pynfunc.build_int(size, signed)

        self.encoder.add_type(int, encode)
        self.decoder.add_type(decode)

    def add_float(self, _64bit: bool = True) -> None:
        encode, decode = pynfunc.build_float(_64bit)
    ...
    def add_str(self, size: int = None) -> None:
        ...
        encode, decode = pynfunc.build_str(size)
    ...
    def add_list(self, size: int = None) -> None:
        ...
        encode, decode = pynfunc.build_list(size)
    ...
    def add_tuple(self, size: int = None) -> None:
        ...
        encode, decode = pynfunc.build_tuple(size)
    ...
    def add_set(self, size: int = None) -> None:
        ...
        encode, decode = pynfunc.build_set(size)
    ...
    def add_dict(self, size: int = None) -> None:
        ...
        encode, decode = pynfunc.build_dict(size)
